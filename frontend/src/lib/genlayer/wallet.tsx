...
import { CHAIN_HEX, CHAIN_ID, RPC_URL, provider } from "./client";
...
const DISCONNECTED = "faultline.wallet.disconnected";
...
export function WalletProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo(() => ({ ...state, connect, switchNetwork, disconnect }), [state, connect, switchNetwork, disconnect]);
